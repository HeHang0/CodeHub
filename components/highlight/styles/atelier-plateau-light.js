export default {
  ...
  "hljs-deletion": "  background-color: #ca4949;",
  "hljs-addition": "  background-color: #4b8b8b;",
  "hljs": "  display: block;  overflow-x: auto;  background: #f4ecec;  color: #585050;  padding: 0.5em;",
